  ...
  chartInstance)
{
  ...
  static const int32_T c28_relationalopType[4] = { 0, 0, 0, 0 };
  ...
  static const int32_T c28_b_relationalopType[2] = { 0, 0 };
  ...
  static const int32_T c28_c_relationalopType[4] = { 0, 0, 0, 0 };
  ...
  static const int32_T c28_d_relationalopType[4] = { 0, 0, 0, 0 };
  ...
  static const int32_T c28_e_relationalopType[4] = { 0, 0, 0, 0 };
  ...
  static const int32_T c28_f_relationalopType[2] = { 0, 0 };
  ...
  static const int32_T c28_g_relationalopType[4] = { 0, 0, 0, 0 };
  ...
  static const int32_T c28_h_relationalopType[4] = { 0, 0, 0, 0 };
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(300003648U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3883025246U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3243591653U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2764971706U);
}
...
{
  return "s1jAMJaNO3DqaGJpMWUxFUF";
}
...
const char* sf_c28_canblocks_extras_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [28] = {
    "eNrtXE9T20YUlzGhQICQTDo9tMNkemkPPSSk0+FWwMaNUwy0NuSoWaTF3iKtxO7KOP0AnZ46+Qi",
    "d6cdoZ9qPklPPvbTTQw99K8t/WCQbYwwheZqRxZr3Z9/b3+57+yTZypUrFhxLcP5btawZuM7COW",
    "W1jztJO9d3tr+ftj5J2r8AEY/8PSKIL62BByc+/ZbKwIsUC3iZHwWpZIwfUUG5A7RhIFSWNMn8y",
    "GP8uBRxR8uTLxrMaVQbQeS5m8BL3F3uvQRpYaT2QE6RCeqoEqWuaoggqjdKHql3eyzUaaFBnWMZ",
    "+YNMkFRVo1B3S1YiT7HQo1st6pS5VAR6LHt9qyqiaEG1Ms3UlspqhzDwQ48Rnmptg8gqDcHBiu6",
    "HLnzuRgqMMsmcBhFqkzZIk8ptdhzLDDg1ZTIJ/zhknKhAMOJt+V5BM57v254H/akELvUGOAT6ti",
    "koOQ4DxlX2+FdLYOkWJ4ceLdLDqJ4trUpPIj34B4yeUpHpt6NC0KSC1Okuz1QaO2SrFY9WFyXny",
    "RTz6QERGw6Mn6RuJnoBObJKYJxoDTiyyGhsZFnWBGuCezOlRX5ZI3PYlIn89mDLYWSxtK0mHTQK",
    "XWklhxeI58lMsloQbtMm9WKpRaLIYLK21HS6UAQhqQNqXXCyhngh4C47NxZOJFXgFwBuxe3tHVg",
    "p0jvXIytzRcURcWjavJVOg7qRR8FQWJlUrC5FqMukHq0hVMmYDqOy5FHEi6eBOAZDB0z7ngl6DD",
    "IJfVkH7wN29yXAfBCZ9v5Qus46/9jqrfMLF1jn7yV8lnH9tE9OLkWO1Xc19c5NnaXPG3qn4JtcL",
    "hfzrffxLRp6pg0+TbcM52dkNb/yw2+rf/7364ff//PT38P0587pz8V/a75X+dHi4lLS/qizAHXh",
    "2TyHCk37rK9f0ynyP+iTv5y05ZPvNirPyc7u0+IJ+ep5WHmx3yrtl2J5r6cG9zdv9Lfz/SO9Er4",
    "M43VNCqfsJgFbt0nUDmNa/lpff2eG+GMu+b59zK6Pxf+ar5t4SPPXPcNfuu0Evk+4aztBpBeNMz",
    "i+vD2PxrMn0b83xJ4Vw56VOP7ZBKJZk9rO6prtEH7oBYAxm7aUINK6Ivs+vhL7LoNvsC/VsKULr",
    "ieD5vOofBbyvRF8uXfQvovE5/wl+axbwjeufaPmKePkNeb6Zhn0y2PomTR95/qqMFq+M5+0H8LZ",
    "22TFqT7kzLIrd3aA3IcpcheT9ud9cnXWbcWVBgphXMuulos9N++Ym6WL5AvLxvgsJ7t8D7bR9gF",
    "oAb1xfWRAXjWV0v+OXB3fv2b8zLayluRZnUOXJ8rcpa2kXWRnSyldk6tKMF4/F9fT7Jo17NLtXd",
    "WgAobmIvzvGfy6HcEef82ujZlX/PX7mPxfjjPv0G+X89tV+HsS+eMDQ++DZP4qolcMe8N1BZWyJ",
    "w/nMc5jnMfXP48vGYcLkRCUKzuukms5f+RGy09w/iIOR4kn7xt6dduxIYZQZRPPs4sb39gek3GO",
    "qeX9aGXj0boBPN6mOF0fEKdxnuM8n2S8mTf0zrfjzTPCXa9zExBxiDic9Lp439B7v43DCpEw7p0",
    "ChIX7F9y/oN/e5HgyZ+ida+c3ldrGnhIWxhPE4fXgcMnQuxTvX04FU9SO/Z7cH348nY3DPOIQ4w",
    "j6bSy/pfFrvz1dtWu47l1X3UZXbahHfV1CjB9RjR8pxfUP5zH6Df32tt8/gfVPEaHgMwh18Rr3H",
    "4jDSeNwwdC7YOCwI+fnmWwc3kEcYhxBv6Hf0G+3fr/75Avc704izt419N5NnnuLn5SJJNabMd+7",
    "MRx26s0uOcH7lhhHsG56g/P3MjiFOBK/y43zFuctxt3bU++rp7y3hPkf4vC6n6Ost+NH98EXxCH",
    "icNI4XDT0Llrt5/aJ233sBe/7Yj6DfsP921u17qX+3o3NOFO6/BK/qoTxF+PvjdQB6yn1aHxfbv",
    "jvc5h+mPTvf/wPwVDFlw==",
    ""
  };

  static char newstr [1973] = "";
  newstr[0] = '\0';
  for (i = 0; i < 28; i++) {
...
static void mdlSetWorkWidths_c28_canblocks_extras(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(53633324U));
  ssSetChecksum1(S,(851215902U));
  ssSetChecksum2(S,(465304806U));
  ssSetChecksum3(S,(4119787130U));
}
